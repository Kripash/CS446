...
*
* This function takes in a string and checks to see if there is a whitespace at the end of it. If there is, the function creates a new string that has everything but the last whitespace at the end.
